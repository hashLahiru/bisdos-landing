...
@section('content')
    <!-- Hero (Video popup) -->
    <section class="mt-sm-2 mt-md-4 mt-lg-5 container mt-1 pt-5">
        <div class="pb-sm-3 pb-lg-0 pb-xxl-2 mb-lg-5 mx-auto mb-4 pb-2 text-center" style="max-width: 650px">
            <h1 class="text-body fs-xs fw-medium text-uppercase mb-sm-4">
        ...
        <div class="position-relative">
            <div class="ratio" style="--cz-aspect-ratio: calc(672 / 1296 * 100%)">
                <img src="assets/img/about/v2/hero.jpg" class="rounded-5" alt="Image" />
            </div>
            <a class="btn btn-lg btn-light rounded-pill position-absolute top-50 start-50 translate-middle z-2"
                href="https://www.youtube.com/watch?v=kkiJftHG3Wo" data-glightbox="" data-gallery="video">
    ...
    <section class="mt-sm-3 mt-md-4 mt-lg-5 container mt-1 pt-5">
        <div class="row row-cols-1 row-cols-md-3 gy-3 gy-sm-4 gx-2 gx-lg-4">
            ...
            <div class="col text-center">
                ...
                <p class="fs-sm mb-md-0 px-5">
                    We choose raw materials from the best manufacturers, so our furniture and
                    decor are of the highest quality at the best prices.
                </p>
            </div>
            <div class="col text-center">
                <svg class="d-block text-dark-emphasis mb-lg-4 mx-auto mb-3" xmlns="http://www.w3.org/2000/svg"
                ...
                <p class="fs-sm mb-md-0 px-5">
                    We will deliver to your door anywhere in the world. If you're not 100%
                    satisfied, let us know within 30 days and we'll solve the problem.
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="mt-md-4 mt-xl-5 mb-xxl-3 container pb-5 pt-5">
        ...
        <div class="row py-lg-5 py-4">
            <div class="col-md-6 col-lg-7">
                <div class="position-relative h-100">
                    ...
                    <img src="assets/img/blog/grid/v2/01.jpg"
            ...
            <div class="col-md-6 col-lg-5">
                <div class="py-md-5 my-lg-3 my-xl-4 my-xxl-5 ps-md-3 ps-lg-4 ps-xxl-5 pt-4">
                    <h3 class="mb-4">Decorate your space with eco-friendly furniture</h3>
                    <p>
                        Eco-friendly furniture help reduce your carbon footprint, but it also
                        provides a healthier living environment for you and your loved ones. It
                        crafted with sustainable materials such as bamboo, reclaimed wood, or
                        recycled plastic.
                    </p>
                    <hr class="my-lg-5" />
                    <div class="d-flex gap-3">
                        <span class="display-5 text-success-emphasis">75%</span>
        ...
        <div class="row py-lg-5 py-4">
            <div class="col-md-6 col-lg-7 order-md-2">
                <div class="position-relative h-100">
                    <div class="ratio ratio-16x9"></div>
                    <img src="assets/img/blog/grid/v2/02.jpg"
                        class="position-absolute w-100 h-100 object-fit-cover rounded-5 start-0 top-0" alt="Image" />
                </div>
            </div>
            <div class="col-md-6 col-lg-5 order-md-1">
                <div class="py-md-5 my-lg-3 my-xl-4 my-xxl-5 pe-md-3 pe-lg-4 pe-xxl-5 pt-4">
                    <h3 class="mb-4">Quality in every detail</h3>
                    <p>
                        We always choose raw materials from the best manufacturers, so our
                        furniture and decor are of the highest quality in every detail at the
                        best prices.
                    </p>
                    <hr class="my-lg-5" />
                    <figure class="mb-0">
                        <blockquote class="blockquote">
                            <p class="fs-base">
                                "Every Cartzilla project is an opportunity to create value for
                                homeowners on many levels. Working with materials from the best
                                manufacturers is an added bonus."
                            </p>
                        </blockquote>
    ...
    <!-- Features -->
    <section class="bg-dark mt-n2 mt-sm-0 py-5" data-bs-theme="dark">
        <div class="pt-sm-2 pt-md-3 pb-md-2 pt-lg-4 pb-lg-3 pb-xl-4 pt-xl-5 pb-xxl-5 mt-xxl-3 container pt-1">
            <div class="row">
                <div
                    ...
                    <a class="btn btn-lg btn-outline-light rounded-pill ms-sm-auto ms-lg-0"
                    ...
                    <div class="overflow-auto" data-simplebar="">
                        <div class="d-flex gap-4">
                            <div class="w-100" style="min-width: 230px">
                                <img src="assets/img/about/v2/feature01.jpg" class="d-block rounded-4 mb-4"
                                    alt="Image" />
                                <h3 class="h5 mb-2 pb-1">Customer focus</h3>
                                <p class="text-body fs-sm mb-4">
                                    We give each client as much attention and time as necessary to
                                    understand their wishes and get the perfect result that will satisfy
                                    the client in full.
                                </p>
                            </div>
                            <div class="w-100" style="min-width: 230px">
                                <img src="assets/img/about/v2/feature02.jpg" class="d-block rounded-4 mb-4"
                                    alt="Image" />
                                <h3 class="h5 mb-2 pb-1">Attention to the details</h3>
                                <p class="text-body fs-sm mb-4">
                                    We are convinced that the devil is in the details, and there are no
                                    insignificant details, so we carefully monitor everything - from the
                                    supply and selection of high-quality wood to the finest work during
                                    the furniture finishing.
                                </p>
                            </div>
                            <div class="w-100" style="min-width: 230px">
                                <img src="assets/img/about/v2/feature03.jpg" class="d-block rounded-4 mb-4"
                                    alt="Image" />
                                <h3 class="h5 mb-2 pb-1">Betting on reputation</h3>
                                <p class="text-body fs-sm mb-4">
                                    Responsible for the integrity, quality and adherence to deadlines in
                                    the production of orders, because the professional reputation of the
                                    workshop is crucial.
                                </p>
                            </div>
                        </div>
    ...
    <section class="pt-sm-2 pt-md-3 pt-lg-4 pt-xl-5 mt-xxl-3 container pt-1">
        <div class="row row-cols-1 row-cols-md-2 g-0 rounded-5 mt-5 overflow-hidden">
            <!-- Map -->
            <div class="col position-relative">
                ...
                <div class="position-absolute d-flex align-items-end w-100 h-100 z-2 bottom-0 start-0 p-4">
                    <a class="btn btn-lg btn-light rounded-pill m-md-2"
                        ...
                        data-glightbox="width: 100vw; height: 100vh;" data-gallery="map">
                        <i class="ci-map fs-lg ms-n1 me-2"></i>
                        Show on map
                    </a>
                </div>
            </div>
            ...
            <div class="col bg-body-tertiary order-md-1 px-xl-5 px-4 py-5">
                <div class="py-md-4 py-lg-5 px-md-4 px-lg-5">
                    ...
                    <ul class="list-unstyled pb-sm-2 mb-0">
                        <li class="d-flex">
                            <i class="ci-map-pin fs-lg mt-1"></i>
                            <span class="ms-1 ps-2">
                                New York 11741, USA
                                <br />
                        ...
                        <li class="nav animate-underline">
                            <i class="ci-phone fs-lg me-1 mt-1 pe-2"></i>
                            <a class="nav-link animate-target fs-base fw-normal p-0" href="tel:+15053753082">
                                +1&nbsp;50&nbsp;537&nbsp;53&nbsp;082
                            </a>
                        </li>
                        <li class="nav animate-underline">
                            <i class="ci-mail fs-lg me-1 mt-1 pe-2"></i>
                            <a class="nav-link animate-target fs-base fw-normal p-0" href="mailto:info@cartzilla.com">
                                info@cartzilla.com
                            </a>
                        </li>
                    </ul>
                    <hr />
                    <ul class="list-unstyled pt-sm-2 mb-0">
                        <li class="d-flex">
                            <i class="ci-map-pin fs-lg mt-1"></i>
                            <span class="ms-1 ps-2">
                        ...
                        <li class="nav animate-underline">
                            <i class="ci-phone fs-lg me-1 mt-1 pe-2"></i>
                            <a class="nav-link animate-target fs-base fw-normal p-0" href="tel:+17825640030">
                                +1&nbsp;78&nbsp;256&nbsp;40&nbsp;030
                            </a>
                        </li>
                        <li class="nav animate-underline">
    ...
    <!-- Blog grid -->
    <section class="my-sm-3 my-lg-4 my-xl-5 container my-2 py-5">
        <!-- Heading -->
        <div class="d-flex align-items-center justify-content-between mb-sm-3 mt-xxl-3 mb-2 pb-3">
            <h2 class="mb-0">Blog and news</h2>
            <div class="nav ms-3">
        ...
        <div class="row gy-5 mb-xxl-3">
            ...
            <article class="col-md-6">
                <a class="ratio d-flex hover-effect-scale rounded-4 overflow-hidden" href="#!"
                    style="--cz-aspect-ratio: calc(500 / 636 * 100%)">
                    <img src="assets/img/blog/grid/v2/15.jpg" class="hover-effect-target" alt="Image" />
                </a>
                <div class="pt-4">
                    <div class="nav mb-1 pb-2">
                    ...
                    <div class="nav align-items-center fs-xs gap-2">
                        <a class="nav-link text-body-secondary fs-xs fw-normal p-0" href="#!">
                            Ava Johnson
                        </a>
                        <hr class="vr mx-1 my-1" />
                ...
                <div class="row row-cols-1 row-cols-sm-2 gy-5">
                    ...
                    <article class="col">
                        ...
                        <div class="pt-4">
                            ...
                            <h3 class="h6 mb-3">
                                <a class="hover-effect-underline" href="#!">
                                    Furnishing your space: a guide to choosing the perfect furniture
                                    pieces
                                </a>
                            </h3>
                            <div class="nav align-items-center fs-xs gap-2">
                    ...
                    <article class="col">
                        ...
                        <div class="pt-4">
                            ...
                            <h3 class="h6 mb-3">
                                <a class="hover-effect-underline" href="#!">
                                    Transform your living space with these chic interior design tips
                                </a>
                            </h3>
                            <div class="nav align-items-center fs-xs gap-2">
                                <a class="nav-link text-body-secondary fs-xs fw-normal p-0" href="#!">
